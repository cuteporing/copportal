...
{
	function element_tag($element, $param = array())
	{
...
/**
 * Generates any kind of create element
 *
 * @access	public
 * @param	string, string, array
 * @return	string
...
{
	function create_tag($element, $text='', $param = array())
	{
...
/**
 * Generates any kind of element end tag
 *
 * @access	public
 * @param	string, string, array
 * @return	string
