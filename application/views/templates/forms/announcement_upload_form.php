<?php echo form_open_multipart('announcements_ajax/upload_photo');?>
...
<div class="form-group">
	...
	<input type="hidden" name="announcement_id" value="<?php if( isset($announcement_id) ){ echo $announcement_id; }?>">
